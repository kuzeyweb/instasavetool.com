...
export default function PrivacyPolicy() {
    ...
    return (
        <>
            <Head>
                <title>Contact - Download Instagram Photos, Videos & Reels - Insta Save Tool </title>
                        ...
                        <div className="container">
                            <div className="tab-content translations-content-item en visible" id="en">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><strong>Company</strong> {`(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Insta Save Tool.`}</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <p><strong>Website</strong> refers to Insta Save Tool, accessible from <a href="https://www.instasavetool.com" rel="noreferrer" target="_blank">https://www.instasavetool.com</a></p>
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    <li>By visiting this page on our website: <a href="www.instasavetool.com/contact" rel="external nofollow noopener" target="_blank">www.instasavetool.com/contact</a></li>
                                </ul>
                            </div>
                        </div></div>
                </div>
